...
class CodeMirror(
    ...
    def highlight_lines(
        ...
        Args:
            line_numbers: List of 1-indexed line numbers to highlight
            css_class: CSS class to apply to the lines (default: "cm-highlighted")
            duration_ms: Time in ms before removing highlight, 0 for permanent (default: 1500)
        """
        # Convert to 0-indexed for JavaScript
